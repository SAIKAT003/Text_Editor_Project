...
public class BasicDocument extends Document 
{
	...
	public int getNumSentences()
	{
        ...
        // if you need help.
		List<String> tokensen = getTokens("[^!?.]+");
		return tokensen.size();
	}
	...
	public int getNumSyllables()
	{
		...
		//List<String> tokensy = getTokens("[aeiouyAEIOUY]+");
		//List<String> loneEs = getTokens("[^aeiouyAEIOUY]+[eE]\\b");
		//List<String> singleEs = getTokens("\\b[^aeiouyAEIOUY]*[eE]\\b");
	//	return tokensy.size() - (loneEs.size() - singleEs.size());
		List<String> tokensiy = getTokens("[a-zA-Z]+");
		int totalSyllables = 0;
		for (String word : tokensiy)
		{
