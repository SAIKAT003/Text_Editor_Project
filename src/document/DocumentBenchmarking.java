	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			for(int j = 0; j<trials;j++) {
				...
				double score = obj.getFleschScore();
				
			}
			long timeEnd = System.nanoTime();
			System.out.print(((timeEnd - timeStart)/1000000000d) + "\t");
			
			timeStart = System.nanoTime();
			for(int j = 0; j<trials;j++) {
				EfficientDocument obj2 = new EfficientDocument(text);
				double score = obj2.getFleschScore();
